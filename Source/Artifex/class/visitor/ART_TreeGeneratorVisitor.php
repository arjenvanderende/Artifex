 ...
 **/
  ...
  class ART_TreeGeneratorVisitor extends ART_Visitor
  {
    ...
    /**
     *  Write the code for a Inputfield
     *  Param: $component - The $component that calls the visitor
     *         $tab       - The tabulation offset
     **/
    public function VisitInput( ART_Input &$component, $tab = "" )
    {
      echo $this->TabToNBSP( $tab ) . "ART_Input: " . $component->GetID() . "<br/>\n";
    }
    ...
    {
      echo $this->TabToNBSP( $tab ) . "ART_TextArea: " . $component->GetID() . "<br/>\n";
    }
    ...
    {
      echo $this->TabToNBSP( $tab ) . "ART_Button: " . $component->GetID() . "<br/>\n";
    }
    ...
    {
      echo $this->TabToNBSP( $tab ) . "ART_Form: " . $component->GetID() . "<br/>\n";
    }
