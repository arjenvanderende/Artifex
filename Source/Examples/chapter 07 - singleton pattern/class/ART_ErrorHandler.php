 ...
 **/
  ...
  class ART_ErrorHandler
  {
    ...
    /**
     *  Constructor
     *  Private so it cannot be instanciated manually
     **/
    private function __Construct() {}

    /**
     *  Return the only instance of the errorhandler
     **/
    public static function GetInstance()
    {
      if( ART_ErrorHandler::$instance == NULL )
        ART_ErrorHandler::$instance = new ART_ErrorHandler();
      return ART_ErrorHandler::$instance;
    }
