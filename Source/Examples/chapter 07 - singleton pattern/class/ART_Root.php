 ...
 **/
  ...
  class ART_Root
  {
    ...
    /**
     * Constructor
     * Create a new instance of the root
    ...
    /**
     * Return the instance of the root
     **/
    public static function &GetInstance()
    {
      if( ART_Root::$instance == NULL )
        ART_Root::$instance = new ART_Root();
      return ART_Root::$instance;
    }

    /**
     * Set the title of the webapplication
