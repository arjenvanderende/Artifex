 ...
 **/
  ...
  $content->AddComponent( $content_image_link );                                   // Add the user-image to the contentgroup
  ...
  $content->AddComponent( $content_paragraph3_link );

  /* Create the footer of the webpage */
