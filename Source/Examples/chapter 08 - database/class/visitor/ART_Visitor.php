 ...
 **/
  ...
  abstract class ART_Visitor
  {
    ...
    abstract public function VisitInput      ( ART_Input     &$component, $tab = "" );
    abstract public function VisitTextArea   ( ART_TextArea  &$component, $tab = "" );
    abstract public function VisitButton     ( ART_Button    &$component, $tab = "" );
    ...
    abstract public function VisitFormHeader ( ART_Form      &$component, $tab = "" );
    abstract public function VisitFormFooter ( ART_Form      &$component, $tab = "" );
  }
